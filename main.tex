...
% Conservative and mechanism-focused:
% \title{Hippocampal Memory Consolidation for Continual Model Adaptation}

% Selectivity-focused, concise:
% \title{Selective Memory Consolidation for Continual Model Adaptation}

% ML-oriented and less neuroscience-heavy:
% \title{Selective Memory Consolidation for Adaptive Model Learning}

% Method-name focused:
% \title{HAT: Hippocampus-Augmented Transformer for Selective Memory Consolidation}

% Narrative-focused, stronger hook:
% \title{Learning What to Remember: Selective Memory Consolidation for Continual Model Adaptation}
...
\begin{abstract}
Contemporary large language models are trained on internet-scale corpora and scaled to massive parameter regimes, incurring substantial costs in training, deployment, and continual adaptation.
